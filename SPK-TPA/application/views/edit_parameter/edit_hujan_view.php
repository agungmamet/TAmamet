  ...
  <div class="col-md-6">
    ...
    <div class="box box-success" style="opacity: 0.9;">
          <div class="box-header with-border">
            <h3 class="box-title">Edit Data Curah Hujan</h3>
          </div>
            <!-- /.box-header -->
            <!-- form start -->
        <?php foreach ($edit as $e) { ?> <!-- $edit berasal dari controller function edit ['edit'] -->
        <form class="form-horizontal" action="<?php echo base_url();?>index.php/parameter/Hujan/updatehujan" method="POST">
            <input type="hidden" name="idklasifikasi" value="<?php echo $e->id_klasifikasi?>" required>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="nilaiklasifikasi" style="width: 333px;" required>
                        ...
                        <option value="0 <?php echo $e->curah_hujan?>">(0) >4000</option>
                        <option value="1 <?php echo $e->curah_hujan?>">(1) 2750-4000</option>
                        <option value="2 <?php echo $e->curah_hujan?>">(2) 1500-2750</option>
                      </select>
                    </div>
                  </div>
              ...
              <div class="box-footer">
                  <a href="<?php echo base_url();?>index.php/parameter/Hujan/index">
