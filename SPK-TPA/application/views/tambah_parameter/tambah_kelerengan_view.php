    ...
    <div class="col-md-6">
      ...
      <div class="box box-success" style="opacity: 0.9;">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah Data Kelerengan</h3>
          </div>
            <!-- /.box-header -->
            <!-- form start -->
        <form class="form-horizontal" action="<?php echo base_url();?>index.php/parameter/Kelerengan/simpankelerengan" method="POST">
            <div class="box-body">
              <?php echo form_open(); ?>
                ...
                <label for="inputEmail3" class="col-sm-4 control-label">Nilai Klasifikasi</label>
                    <div class="col-sm-8">
                      <select class="form-control" name="nilaiklasifikasi" style="width: 333px;" required>
                        ...
                        <option value="1">(1) 25-40%</option>
                        <option value="2">(2) 15-25%</option>
                        <option value="3">(3) 8-15%</option>
                        <option value="4">(4) 0-8%</option>
                      </select>
                    </div>
              </div>
