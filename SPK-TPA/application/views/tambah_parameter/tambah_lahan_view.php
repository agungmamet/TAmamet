    ...
    <div class="col-md-6">
      ...
      <div class="box box-success" style="opacity: 0.9;">
          <div class="box-header with-border">
            ...
            <!-- /.box-header -->
            <!-- form start -->
        <form class="form-horizontal" action="<?php echo base_url();?>index.php/parameter/Lahan/simpanlahan" method="POST">
            <div class="box-body">
              <?php echo form_open(); ?>
                ...
                <label for="inputEmail3" class="col-sm-4 control-label">Nilai Klasifikasi</label>
                    <div class="col-sm-8">
                      <select class="form-control" name="nilaiklasifikasi" style="width: 333px;" required>
                        ...
                        <option value="0">(0) Hutan</option>
                        <option value="1">(1) Pemukiman</option>
                        <option value="2">(2) Sawah/Ladang/Tambak</option>
                        <option value="3">(3) Kebun/Lapangan</option>
                        <option value="4">(4) Industri</option>
                      </select>
                    </div>
              </div>
